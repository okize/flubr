...
module.exports = function($) {
  ...
  showMessage = function(msg) {
    return $('#messaging').prepend("<li>" + msg + "</li>");
  };
  ...
  switchImageKind = function(el, newKind) {
    ...
    return el.closest('.set-image-kind').html(getImageSetHtml(newKind));
  };
